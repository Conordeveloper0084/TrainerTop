  ...
  return (
    <div className="min-h-screen bg-dark">
      <div className="container-main max-w-3xl py-10">
        ...
        <p className="text-sm text-white/40 mb-10">Oxirgi yangilanish: 2026-yil, sentabr</p>
        ...
        <div className="prose-custom space-y-8">
          ...
          <Section title="8. Chat va darslik guruhlari">
            <p>Har bir e'lon qilingan darslik uchun yopiq guruh avtomatik yaratiladi. Unga faqat darslikni sotib olganlar va darslik egasi (trener) kira oladi. Oylik obuna muddati tugasa, guruh sizga yopiladi (chatlar ro'yxatida ko'rinib turadi, lekin ichiga kirib bo'lmaydi) va oylik to'lov yangilanganda qayta ochiladi.</p>
            <p>Trener o'z guruhining administratori hisoblanadi: guruh nomi, tavsifi va rasmini o'zgartira, a'zolarning xabarlarini o'chira va a'zolarni guruhdan chiqara oladi. Guruhdan chiqarilgan a'zoning sotib olingan darslikka kirish huquqi saqlanib qoladi.</p>
            <p>Chatda matn, ovozli xabar, rasm va video yuborish mumkin. Guruhga yuborilgan xabar va fayllarni guruhning barcha a'zolari ko'radi — shaxsiy yoki sog'liqqa oid rasmlarni (masalan, natija rasmlari) yuborishdan oldin buni hisobga oling. Boshqa odamning rasmi yoki shaxsiy ma'lumotini uning roziligisiz yubormang.</p>
            <p>Xabar o'chirilganda uning matni va biriktirilgan fayli platforma xotirasidan ham o'chiriladi.</p>
            <p>Guruhlarda va shaxsiy chatlarda haqorat, reklama, spam, 18+ va noqonuniy kontent taqiqlanadi. Qoidabuzarlik haqida support@trainertop.uz manziliga xabar bering. Platforma qoidabuzar akkaunt yoki guruhni cheklash yoki yopish huquqiga ega.</p>
            <p>Platforma trener va a'zolar o'rtasidagi yozishmalar mazmuni uchun javobgar emas; guruhda tartibni saqlash uchun birinchi navbatda guruh administratori mas'ul.</p>
          </Section>

          <Section title="9. Javobgarlik chegarasi">
          ...
          <Section title="10. Shartlar o'zgarishi">
