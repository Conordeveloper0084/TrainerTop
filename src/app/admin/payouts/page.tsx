            ...
            <>
              ...
              <div className="bg-red-500/[0.04] border border-red-500/20 rounded-lg p-3 mb-5 flex items-start gap-2">
                ...
                <p className="text-[11px] text-red-400/90 leading-relaxed">
                  <strong>Diqqat:</strong> Faqat haqiqatdan ham pul o'tkazgan bo'lsangiz "Ha, o'tkazildi" tugmasini bosing. Aks holda trener pul kelmagan bo'lsa ham "o'tkazildi" xabarini oladi. (Summa trener balansidan so'rov paytidayoq ushlab qolingan.)
                </p>
              </div>
