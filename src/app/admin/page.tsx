    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <FinanceCard icon={Percent} label="Platforma daromadi" value={formatPrice(stats.total_commission || 0)} sub="10% komissiya" />
          <FinanceCard icon={Wallet} label="Trenerlar balansi" value={formatPrice(stats.total_balance)} sub="Yechishga tayyor" />
          <FinanceCard icon={Clock} label="Pul yechish" value={stats.pending_payouts.toString()} sub="Kutilayotgan" alert={stats.pending_payouts > 0} />
        </div>
      </div>
