...
import { useChatUnread } from "@/lib/shared-poll";
...
export default function MobileBottomNav() {
  ...
  // Chat unread — Navbar bilan bitta umumiy so'rov
  ...
  return (
    <nav className="mobile-bottom-nav md:hidden fixed bottom-0 left-0 right-0 z-40 bg-dark-surface/95 backdrop-blur-xl border-t border-white/[0.06] pb-safe">
